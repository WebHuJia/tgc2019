...
module.exports = function ($data) {
    'use strict';
    $data = $data || {};
    var $$out = '', $each = $imports.$each, tabs = $data.tabs, tab = $data.tab, index = $data.index, item = $data.item, $escape = $imports.$escape;
    $$out += '<div class="blocks-tabs-agenda">\r\n    <div class="header">\u3010TGC 2019\u3011主舞台活动议程表</div>\r\n    <div class="tab-agenda-wrapper">\r\n        <ul class="tabs-agenda">\r\n            ';
...
module.exports = function ($data) {
    'use strict';
    $data = $data || {};
    var $$out = '', $each = $imports.$each, list = $data.list, item = $data.item, index = $data.index, $escape = $imports.$escape, mapImg = $data.mapImg;
    $$out += '<div class="map-wrapper">\r\n    <!-- 显示打卡点的按钮 -->\r\n    <!-- <div class="btn-punch"></div> -->\r\n\r\n    <div id="map" class="map">\r\n        <div class="map-inner">\r\n\r\n            <!-- 地图上的热区 -->\r\n            <div class="hotarea-list">\r\n                ';
...
var _index3 = __webpack_require__("yVHm");
...
var _index7 = __webpack_require__("wPYt");

var _index8 = _interopRequireDefault(_index7);

var _index9 = __webpack_require__("I2If");

var _index10 = _interopRequireDefault(_index9);

var _mapGuide = __webpack_require__("ql7R");

var _mapGuide2 = _interopRequireDefault(_mapGuide);

var _helps = __webpack_require__("xCOh");

var _helps2 = _interopRequireDefault(_helps);

__webpack_require__("E2gC");

var _playCd = __webpack_require__("d9bj");

var _playCd2 = _interopRequireDefault(_playCd);

var _agenda = __webpack_require__("Trcm");

var _agenda2 = _interopRequireDefault(_agenda);

var _mapinfo = __webpack_require__("ir2D");

var _mapinfo2 = _interopRequireDefault(_mapinfo);

__webpack_require__("eRRy");
...
// 初始化tab里的页面
function initPages() {
    // 这里只渲染tab和tab-content的外层框架，
    // 每个tab-content的具体内容渲染好后调用initSlide来初始化swiper
    // “场馆指引”tab是单独的页面
    (0, _index4.default)(".row-scene .mod-tabs-scene", {
        data: _index2.default.scene
    });
    // 渲染场馆指引
    initMapGuidePage().then(function () {
...
function getTabContentSelector(key) {
    return ".mod-tabs-scene .tab-content-wrapper .tab-content-" + key;
}

function initMapGuidePage() {
    var selector = getTabContentSelector("venue");
    return (0, _mapGuide2.default)(selector);
}
...
function initPlayPage() {
    ...
    (0, _index8.default)(selector, {
        data: _playCd2.default
    });
}
...
function initAgendaPage() {
    ...
    (0, _index10.default)(selector, {
        data: _agenda2.default
    });
}
...
__webpack_require__("tqeU");

var _index = __webpack_require__("4XdI");
...
function render(id, options) {
    ...
    function onTouchTab(ev) {
        ...
        $wrapper.find(".tabs-agenda li").eq(index).addClass("on").siblings().removeClass("on");

        $wrapper.find(".tab-content").eq(index).addClass("on").siblings().removeClass("on");
    }

    function bindEvent() {
        $wrapper.on("tap", ".tabs-agenda li", onTouchTab);
    }
}
...
exports.default = {
    tabs: [{
        ...
        list: [{
            time: "10:00~<br/>10:30",
            desc: "超级网剧《素手遮天》主创团队明星见面会携手《剑侠情缘》带你进入唯美江湖"
        }, {
            time: "10:00~<br/>10:30",
            desc: "超级网剧《素手遮天》主创团队明星见面会携手《剑侠情缘》带你进入唯美江湖"
        }, {
...
module.exports = function ($data) {
    'use strict';
    $data = $data || {};
    var $$out = '', belong = $data.belong, $escape = $imports.$escape, index = $data.index, zwmc_8b = $data.zwmc_8b, jj_e7 = $data.jj_e7, $each = $imports.$each, tyd_dc = $data.tyd_dc, item = $data.item;
    $$out += '<div class="btn-close btn-close-game"></div>\r\n';
    if (belong && belong.key_52 == 'ip') {
        $$out += '\r\n    <h4 class="header-game-card">';
        $$out += $escape(belong.zwmc_8b);
        $$out += '</h4>\r\n    <div class="game-info-list">\r\n        <div class="info-item">\r\n            <div class="desc">';
        $$out += $escape(belong.jj_e7);
        $$out += '</div>\r\n        </div>\r\n\r\n        <div class="info-item">\r\n            <!-- <i class="num num-';
        $$out += $escape(index);
        $$out += '"></i> -->\r\n            <h2 class="title">体验内容\uFF1A';
        $$out += $escape(zwmc_8b);
...
var _play = __webpack_require__("m1ny");
...
exports.default = {
    tabs: [{
        title: '成都美食',
        content: '\n            <p>\u7B2C\u5341\u5C4A\u817E\u8BAF\u6E38\u620F\u5609\u5E74\u534E\u5C06\u572812\u67081\u65E5\u523012\u67083\u65E5\u4E0E\u5927\u5BB6\u76F8\u7EA6\u5728\u5929\u5E9C\u4E4B\u56FD\u6210\u90FD\u5566\uFF0C\u90A3\u4E48\u9664\u4E86\u73A9\u5F88\u5927\u7684\u4E3B\u9898\u4E4B\u5916\uFF0C\u8FD8\u6709\u54EA\u4E9B\u8981\u4E3A\u6210\u90FD\u75AF\u72C2\u6253call\u7684\u5403\u559D\u73A9\u4E50\u5730\u65B9\u5462\uFF1F\u60F3\u77E5\u9053\uFF1F\u90A3\u5C31\u8D76\u7D27\u5F80\u4E0B\u770B\uFF01</p> \n            <img src="' + _play2.default + '"/>            \n            <p>\u5305\u6D46\u8C46\u8150\u662F\u8FD9\u6B21\u7684\u60CA\u559C\uFF0C\u670D\u52A1\u5458\u4ECB\u7ECD\u662F\u4E13\u95E8\u5411\u8C46\u8150\u94FA\u5B50\u5B9A\u505A\u7684\uFF0C\u6709\u5E72\u51C0\u7684\u8C46\u9999\uFF0C\u5916\u76AE\u5F88\u6709\u97E7\u6027\uFF0C\u5185\u91CC\u5982\u8C46\u82B1\u822C\u7EC6\u5AE9\uFF0C\u53EF\u4EE5\u8638\u4E00\u70B9\u8C03\u5473\u8FC7\u7684\u8FA3\u6912\u9762\uFF08\u56DB\u5DDD\u8BDD\u53EB\u5E72\u789F\u5B50\uFF09\uFF0C\u9999\u800C\u4E0D\u8FA3\u3002 </p>\n            '
    }, {
        title: '成都风景',
        content: '\n            <p>\u7B2C\u5341\u5C4A\u817E\u8BAF\u6E38\u620F\u5609\u5E74\u534E\u5C06\u572812\u67081\u65E5\u523012\u67083\u65E5\u4E0E\u5927\u5BB6\u76F8\u7EA6\u5728\u5929\u5E9C\u4E4B\u56FD\u6210\u90FD\u5566\uFF0C\u90A3\u4E48\u9664\u4E86\u73A9\u5F88\u5927\u7684\u4E3B\u9898\u4E4B\u5916\uFF0C\u8FD8\u6709\u54EA\u4E9B\u8981\u4E3A\u6210\u90FD\u75AF\u72C2\u6253call\u7684\u5403\u559D\u73A9\u4E50\u5730\u65B9\u5462\uFF1F\u60F3\u77E5\u9053\uFF1F\u90A3\u5C31\u8D76\u7D27\u5F80\u4E0B\u770B\uFF01</p> \n            <img src="' + _play2.default + '"/>            \n            '
    }, {
...
module.exports = __webpack_require__.p + "//game.gtimg.cn/images/game/act/a20181206tgc/img/play-0.a99be4a.jpg";
...
module.exports = function ($data) {
    ...
    $each(tabs, function (tab, index) {
        $$out += '\r\n                <div class="tab-content-scene tab-content tab-content-';
        $$out += $escape(tab.key);
        $$out += ' ';
        if (tab.key === cur) {
            $$out += 'on';
...
module.exports = function ($data) {
    'use strict';
    $data = $data || {};
    var $$out = '', $each = $imports.$each, punchCards = $data.punchCards, item = $data.item, index = $data.index, $escape = $imports.$escape;
    $$out += '<div class="btn-close btn-punch-close"></div>\r\n\r\n<h4 class="punch-card-header">打卡点列表</h4>\r\n\r\n<div class="card-list">\r\n    ';
    $each(punchCards, function (item, index) {
        $$out += '\r\n    <a href="javascript:;" class="punch-point-item" data-map="';
        $$out += $escape(item.key_52);
        $$out += '">\r\n        <div class="area-left">\r\n            <img src="';
        $$out += $escape(item.dkdt_bc);
...
exports.default = function (selector) {
    ...
    return Promise.all([loading(), initMap()]);
};

__webpack_require__("Sl9Z");
...
var _mapGuide = __webpack_require__("9SOU");

var _mapGuide2 = _interopRequireDefault(_mapGuide);

var _gameCard = __webpack_require__("WIrb");

var _gameCard2 = _interopRequireDefault(_gameCard);

var _punchCardList = __webpack_require__("pVNc");

var _punchCardList2 = _interopRequireDefault(_punchCardList);

var _mapM = __webpack_require__("s7sb");

var _mapM2 = _interopRequireDefault(_mapM);
...
var zoomMax = 1;
// rem的基础值
var remBase = +document.documentElement.style.fontSize.replace("px", "");
var mapRemW = 6.5;
var mapRemH = 10.14;
var imgRemW = 25;
var imgRemH = 18.88;
// 最小缩放尺寸根据可视区域的高度决定，地图的高度 == 可视区域高度
var zoomMin = void 0;
var mapW = remBase * mapRemW;
var mapH = remBase * mapRemH;
// 资料库里的地图数据
var mapData = void 0;
// 打卡点列表的浮层class
var punchListClass = "punch-card-list";
// 游戏点介绍的浮层class
var gamePointCardClass = "game-point-card";
...
function initScroll() {
    ...
    moveTo($container.find(".hotarea-ip"));
}
...
function bindEvent() {
    // 点击热区
    $container.on("tap", ".map .hotarea", onTapHotarea);
    // 点击显示打卡点列表的按钮
    $container.on("tap", ".map-wrapper .btn-punch", showPunchCards);
    // 点击打卡点
    $(document).on("tap", ".punch-card-list .punch-point-item", onTapPunchCard);
    // 点击关闭按钮
    $(document).on("tap", ".btn-close", onTapCloseBtn);
    // 点击返回按钮
...
function onTapCloseBtn(ev) {
    var $btn = $(ev.currentTarget);
    if ($btn.hasClass("btn-punch-close")) {
        hidePunchCards();
        (0, _utils.hideMask)();
    }
    if ($btn.hasClass("btn-close-game")) {
        hideGameCard();
        (0, _utils.hideMask)();
    }
}
...
function showGameCard(tag) {
    ...
    // 查询这个点是否有所属字段，即游戏点属于某个主题区
    var belong = data["ssztq_05"].replace(/\s*/g, "");
    if (belong) {
        data.belong = mapData.themes.find(function (item) {
            return item["key_52"] === belong;
        });
    }

    var $card = $(".wrapper ." + gamePointCardClass);
    // 第一次渲染卡片
    if (!$card.length) {
        var _html = (0, _gameCard2.default)(data);
        $card = $(_html);
        $(".wrapper").append($card);
        $card.show();
        (0, _utils.showMask)();
...
function hideGameCard() {
    $(".wrapper ." + gamePointCardClass).hide();
    (0, _utils.hideMask)();
}

function renderPunchCard(data) {
    var $list = $(".wrapper ." + punchListClass);
    var html = (0, _punchCardList2.default)(data);
    $list.html(html);
}

function showPunchCards() {
    var $list = $(".wrapper ." + punchListClass);
...
function hidePunchCards() {
    $(".wrapper ." + punchListClass).hide();
    (0, _utils.hideMask)();
}

function onTapPunchCard(ev) {
    var $el = $(ev.currentTarget);
...
function moveTo($el) {
    ...
    var pid = setInterval(function () {
        if (scale === zoomMax) {
            var x = -left + Math.round(mapW / 2);
            var y = -top + Math.round(mapH / 2);
            if (x > 0) {
                x = 0;
            }
            if (y > 0) {
            ...
            mapScroll.scrollTo(x, y, translateDuration);
        } else {
            var leftScale = left * scale;
            var topScale = top * scale;
            mapScroll.zoom(zoomMax, leftScale, topScale, translateDuration);
        }
        setMark($el);
        clearInterval(pid);
    }, 100);
...
function setMark($el) {
    var $mark = $container.find(".map-mark");
    if ($mark.length) {
        $mark.remove();
    }
    $mark = $('<div class="map-mark"></div>');
    $el.append($mark);
}
...
function handleZlkData(data) {
    ...
    return {
        list: list,
        themes: themes,
        punchCards: data["ydddkdlb_9c"],
        mapImg: _mapM2.default
    };
}

function getZoomMin() {
    return (mapRemH / imgRemH).toFixed(2);
}
...
function centerModal($modal) {
    ...
    $modal.css('margin-top', -(modalH + closeH) / 2);
}
...
module.exports = __webpack_require__.p + "//game.gtimg.cn/images/game/act/a20181206tgc/img/map-m.42c5c6d.jpeg";
...
__webpack_require__("ay16");

var _index = __webpack_require__("yE9y");
...
function render(id, options) {
    ...
    function initSlides() {
        var controller = new _swiper2.default(id + " .swiper-container-play", {
            on: {
    ...
    function onTouchTab(ev) {
        ...
        $wrapper.find(".tabs-play li").eq(index).addClass("on").siblings().removeClass("on");

        $wrapper.find(".tab-content").eq(index).addClass("on").siblings().removeClass("on");
    }

    function bindEvent() {
        $wrapper.on("tap", ".tabs-play li", onTouchTab);
    }
}
...
module.exports = function ($data) {
    'use strict';
    $data = $data || {};
    var $$out = '', $each = $imports.$each, tabs = $data.tabs, tab = $data.tab, index = $data.index, $escape = $imports.$escape;
    $$out += '<div class="blocks-tabs-play-cd">\r\n    <ul class="tabs-play">\r\n        ';
    $each(tabs, function (tab, index) {
        $$out += '\r\n        <li ';
        if (index === 0) {
            $$out += 'class="on"';
    ...
    $$out += '\r\n    </ul>\r\n    <div class="tab-container">\r\n        ';
    $each(tabs, function (tab, index) {
        $$out += '\r\n        <div class="swiper-slide tab-content ';
        if (index === 0) {
            $$out += 'on';
        }
        $$out += '">';
...
__webpack_require__("K6Wd");

var _index = __webpack_require__("pU6h");
...
function render(id, options) {
    ...
    data.cur = cur;
    var index = data.tabs.findIndex(function (tab) {
        return tab.key === cur;
    });
    // let lastIndex = data.tabs.length - 1;
    render(data);
    bindEvent();
        ...
        var controller = new _swiper2.default(id + " .swiper-container", {
            ...
            on: {
                transitionStart: function transitionStart() {
                    ...
                    // if (this.previousIndex === lastIndex) {
                    //     $(`.mod-tabs-scene .blocks-tabs-play-cd .tab-content`).hide();
                    // }

                    // if (this.realIndex === lastIndex) {
                    //     $(`.mod-tabs-scene .blocks-tabs-play-cd .tab-content`).show();
                    // }
                }
            }
        });

        $wrapper.on("tap", id + " .tabs li", onTouchTab);
    ...
    function onTouchTab(ev) {
        ...
        $el.addClass("on").siblings().removeClass("on");
        // 显示对应的tab内容
        var $tabContent = $($wrapper.find(".tab-content-wrapper .tab-content-scene").get(index));
