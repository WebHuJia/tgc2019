webpackJsonp([0], {
    ...
    /***/
        ...
        var _index = __webpack_require__("I2bu");

        var _index2 = _interopRequireDefault(_index);

        var _title = __webpack_require__("8gNf");

        var _title2 = _interopRequireDefault(_title);

        var _gallery = __webpack_require__("gfxu");

        var _gallery2 = _interopRequireDefault(_gallery);

        var _centered = __webpack_require__("TUyA");
                    ...
                    on: {
                        progress: function progress(_progress) {
                            for (var i = 0; i < this.slides.length; i++) {
                                ...
                                var translate = slideProgress * modify * 300 + "px";
    ...
    /***/
        ...
        module.exports = function($data) {
            ...
            $$out += '\r\n    </ul>\r\n    <a href="/2019/newslist.html" class="btn-more">more</a>\r\n    <div class="content-wrapper">\r\n    ';
            $each(tabs, function(tab, index) {
    ...
    /***/
        ...
        exports.default = {
            ...
            misc: {
                list: [
                    ["联系电话：+86 xxx-xxx-xxx", "商务合作：xxx@tencent.com", "公司地址：深圳市南山区xxxxxxx"],
                    ["客服办公时间：周一至周日 9:00-21:00", "客服支持：xxx@tencent.com"]
                ]
            },
            vid: {
                vid: "y0827w3qjnv"
    ...
    /***/
        ...
        exports.default = function(uniq, options) {
            ...
            var data = options.data,
                ...
                videoWidth = _options$videoWidth === undefined ? "800" : _options$videoWidth,
                _options$videoHeight = options.videoHeight,
                videoHeight = _options$videoHeight === undefined ? "500" : _options$videoHeight;
            /**
             * video对象
             * @type {Txplayer}
             */
            ...
            function bindEvent() {
                $(document).on("click", "" + uniq, showPopup);
                $(document).on("click", "." + closeId, closePopup);
            }
        ...
        __webpack_require__("2fFs");

        var _popvideo = __webpack_require__("lhKb");
    ...
    /***/
        ...
        module.exports = function($data) {
            ...
            var $$out = '',
                ...
                index = $data.index,
                $escape = $imports.$escape;
            $$out += '<div class="blocks-carousel-pc">\r\n    <div class="swiper-container">\r\n        <ul class="swiper-wrapper">\r\n            ';
    ...
    /***/
        ...
        module.exports = __webpack_require__.p + "//game.gtimg.cn/images/game/act/a20181206tgc/img/share.9a87f7a.jpg";
    ...
    /***/
        ...
        var _index = __webpack_require__("qJ7N");

        var _index2 = _interopRequireDefault(_index);

        var _title = __webpack_require__("sHyk");

        var _title2 = _interopRequireDefault(_title);

        var _gallery = __webpack_require__("Qnt7");

        var _gallery2 = _interopRequireDefault(_gallery);

        var _centered = __webpack_require__("WhfT");
        ...
        function render(id, options) {
            ...
            function initDefaultSlides() {
                ...
                // 绑定外部的nav事件
                $wrapper.on('click', '.carousel-nav', function(ev) {
                    var $el = $(ev.currentTarget);
    ...
    /***/
        ...
        __webpack_require__("mDso");

        var _index = __webpack_require__("2xcx");
    ...
    /***/
        ...
        (function(setImmediate, global) {
            ...
            /* WEBPACK VAR INJECTION */
        }.call(exports, __webpack_require__("162o").setImmediate, __webpack_require__("DuR2")))
    ...
    /***/
        ...
        __webpack_require__("Fdtw");

        var _index = __webpack_require__("YjuI");
    ...
    /***/
        ...
        module.exports = __webpack_require__.p + "//game.gtimg.cn/images/game/act/a20181206tgc/img/favico.9a87f7a.jpeg";
    ...
    /***/
        ...
        __webpack_require__("PIuJ");

        __webpack_require__("kElX");

        var _index3 = __webpack_require__("ayFF");

        var _index4 = _interopRequireDefault(_index3);

        var _index5 = __webpack_require__("4pYY");

        var _index6 = _interopRequireDefault(_index5);

        var _index7 = __webpack_require__("1ojQ");

        var _index8 = _interopRequireDefault(_index7);

        var _index9 = __webpack_require__("aSAG");

        var _index10 = _interopRequireDefault(_index9);

        var _index11 = __webpack_require__("vwUU");

        var _index12 = _interopRequireDefault(_index11);

        var _index13 = __webpack_require__("S+PU");

        var _index14 = _interopRequireDefault(_index13);

        var _index15 = __webpack_require__("j3TR");

        var _index16 = _interopRequireDefault(_index15);

        var _index17 = __webpack_require__("n8ar");

        var _index18 = _interopRequireDefault(_index17);

        var _index19 = __webpack_require__("5UW2");

        var _index20 = _interopRequireDefault(_index19);

        function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

        // import MiscInfo from "../../modules/blocks-misc-info/pc/index";
        init();
        ...
        function initSyncMods() {
            // 播放品牌概念的按钮
            (0, _index6.default)(".btn-play", {
                data: _index2.default.vid,
                videoWidth: 1080,
                videoHeight: 602
            });
            // MiscInfo(".row .mod-misc-info", {
            //     data: data.misc
            // });
            (0, _index18.default)(".mod-footer", {});
            (0, _index20.default)(".mod-float-qrcode", {});
        }

        function initAsyncMods() {
            (0, _v4DataService.getV4NewsTabsData)({
                bizId: _index2.default.gicpBizId,
                tabs: _index2.default.newsTabList.pc,
                source: "web_pc",
                pageSize: 9,
                type: "pc"
            }).then(function(tabList) {
                // 新闻tab
                (0, _index10.default)(".row-news .mod-tab-news", {
                    data: {
                        tabs: tabList
                    }
                });
            ...
            (0, _v4DataService.getNewsCarouselData)("pc").then(function(ret) {
                // 新闻轮播
                (0, _index8.default)(".row-news .mod-carousel-news", {
                    data: {
                        list: ret
                    }
                });
            });
            (0, _v4DataService.getCCIData)("pc").then(function(list) {
                // 四大文创
                (0, _index12.default)(".row .mod-cci-pic", {
                    data: {
                        list: list
                    }
                });
            });
            (0, _v4DataService.getAdsData)("pc").then(function(list) {
                // 广告位
                (0, _index14.default)(".row-gg .mod-gg", {
                    data: {
                        list: list
                    }
                });
            ...
            // 合作伙伴
            (0, _v4DataService.getPartnersData)("pc").then(function(ret) {
                (0, _index16.default)(".row .mod-partners", {
                    data: {
                        tabs: ret
                    }
                });
    ...
    /***/
        ...
        var _index = __webpack_require__("LJqb");

        var _index2 = _interopRequireDefault(_index);

        var _title = __webpack_require__("dQ68");

        var _title2 = _interopRequireDefault(_title);

        var _gallery = __webpack_require__("svaP");

        var _gallery2 = _interopRequireDefault(_gallery);

        var _centered = __webpack_require__("DbiD");
