...
var _article = __webpack_require__("7UDA");
...
var _index7 = __webpack_require__("5UW2");
...
function initSyncMods() {
    ...
    (0, _index8.default)(".mod-float-qrcode", {});
}
...
function fillNewsData() {
    fillNews.detail({
        ...
        wrap: ".article", // 模板处理完填充进来的容器
        tpl: _article2.default, // 模板字符串
        source: "web_pc", //web_m | web_pc 数据上报用的，表明本页面用于pc或者移动
        // relWrap: ".rel", //相关推荐的容器
        // relTpl:
